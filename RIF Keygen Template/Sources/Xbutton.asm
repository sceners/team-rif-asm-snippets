...
; -------------------------------------------------------------------------
; Lame rip from the MASM32lib
; Now this function supports the gif, jpg, png, bmp buttons !
; La fin jutifie les moyens :)
; -------------------------------------------------------------------------

.code

XButton proc hParent:DWORD,topX:DWORD,topY:DWORD,
  ...
  ; 6   ID number for control
    ...
    invoke BitmapFromResource,hModule,rnum1             ; << here are the changes
    mov hBmpU, eax
